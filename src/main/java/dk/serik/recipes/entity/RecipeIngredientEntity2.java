...
public class RecipeIngredientEntity2 {
...
//	@MapsId("ingredientId")
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RecipeIngredientEntity2 other = (RecipeIngredientEntity2) obj;
		return Objects.equals(ingredientId.id, other.ingredientId.getId())
				&& Objects.equals(recipeId.id, other.recipeId.getId());
	}
